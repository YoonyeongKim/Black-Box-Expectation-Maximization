classdef all_IMM_forward_baseline < handle
...
%% functions of IMM
    methods
        ...
        function this = all_IMM_forward_baseline(filters, initialState, move_cov_est_initial, betas, thetas, mass, startTime, endTime)
