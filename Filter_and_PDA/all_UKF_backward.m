classdef all_UKF_backward < handle
...
%% functions of UKF
    methods
       %% func1. Initialization
        function this = all_UKF_backward(F,paramF,H,paramH,initialState,move_cov_est_initial,observationSize,alpha,beta,kappa,gamma,mass)
