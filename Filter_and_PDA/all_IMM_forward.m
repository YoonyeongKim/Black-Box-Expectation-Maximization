classdef all_IMM_forward < handle
    ...
    properties
        ...
        massInitial             % Input initial_mass value
...
%% functions of IMM
    methods
        ...
        function this = all_IMM_forward(filters, initialState, move_cov_est_initial, betas, thetas, startTime, endTime, mass_initial, delta_mass)
...
%             fprintf('time:%d -> %d\n',time,time+deltaTime*10);
          ...
          %% parameter setting for base filters
            ...
            mass = this.massInitial - (itr-1)*this.deltaMass;
            betas = this.betas;
            thetas = this.thetas;
