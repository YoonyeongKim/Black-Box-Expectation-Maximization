function dx = dyn_ballisticM_HV61_thrust_inv(x, time, deltaTime, ballistic_coefficient, thrust_magnitude, mass)
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    temp = RK4_thrust(@dyn_ballisticM_thrust_inv, x(1:6,1), 0, 0, 0, deltaTime);
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
