function dx = dyn_ballisticM_thrust_inv(x, b, thr, mass)
    ...
    if t <= Stage_Time.one
        ...
        dMdt = dM.Stage1            ;
%         totMass = totMass - dMdt*t  ;                     
    else
%         totMass = totMass - bal_inform.launchinform.GrWeiStg1  ; 
...
%     magThrBM = dMdt * gBM * ISPT                        ; % magnitude of thrust vector of ballistic missile  
    ...
    accBM = (weiVec + thrBM)/totMass +coriBM  - accDragBM  ; % acceleration of ballistic missile    
